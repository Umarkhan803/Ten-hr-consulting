          ...
          <div className='w-full order-2 lg:order-1 lg:w-1/2 mt-6 lg:mt-10'>
            <div className='space-y-4 lg:space-y-6'>
              ...
              <p className='text-base lg:text-lg'>
                ...
                "At HR Consulting, we simplify business expansion in India by
                providing expert recruitment and HR management services. Our
                team ensures compliance with local employment laws and connects
                you with skilled professionals, allowing you to concentrate on
            ...
            <div className='w-full lg:w-1/2 bg-blue-700 text-white p-6 sm:p-8 lg:p-10 rounded-lg'>
              <div className='OurMission'>
                ...
                <p className='text-sm sm:text-base'>
                  "At HR Consulting, our mission is to empower businesses and
                  entrepreneurs from around the globe in setting up and growing
                  their operations in India.
                </p>
                <p className='text-sm sm:text-base'>
                  We believe that welcoming more entrepreneurs to India benefits
                  the country’s economy, and we are committed to making this
                  process seamless.
                </p>
                <p className='text-sm sm:text-base'>
                  Our focus is on streamlining the process of hiring local
                  talent, ensuring a hassle-free experience that benefits both
                  companies and the Indian job market.
                </p>
                <p className='text-sm sm:text-base'>
                  Understanding India’s regulatory landscape can be challenging,
                  and that's why we're here—to make it easier for you to
                  navigate.
                </p>
                <p className='text-sm sm:text-base'>
                  By easing this process, we open doors to new opportunities and
                  contribute to the success of your business in India.
                </p>
              </div>
            </div>
        ...
        <div className='max-w-screen-2xl container mx-auto flex flex-col lg:flex-row lg:gap-12'>
          ...
          <div className='w-full lg:w-1/2 flex items-center mt-6 lg:mt-0 lg:pl-6'>
            <div className='space-y-4 lg:space-y-6'>
              ...
              <p className='text-base lg:text-lg'>
                "Welcome to HR Consulting! We are your strategic partner for
                business growth in India. With a focus on Employer of Record
                (EOR) services, recruitment solutions, and HR consulting, we are
                dedicated to simplifying your entry and expansion into the
                Indian market. Our expertise helps businesses navigate the
                complexities of hiring and compliance, ensuring a smooth and
                successful journey."
              </p>
              <button
                className='btn btn-warning text-black px-4 lg:px-8 py-2 rounded-md hover:text-white hover:bg-yellow-600 duration-300 cursor-pointer mt-4 lg:mt-6'
